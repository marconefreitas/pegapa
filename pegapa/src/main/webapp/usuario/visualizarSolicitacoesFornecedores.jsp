			...
			<c:forEach items="${lista}" var="item" >
				<div class="row well" style="margin: 0 auto 15px; width:80%; padding:0">
					...
					<div class="media" style="padding:19px;" >
						...
						<div class="pull-left">
							<img src="/pegapa/images/filename${item.fornecedor.codFornecedor}.jpg" class="media-object media-icons" height="75px;" width="75px;">
						</div>
						...
						<div class="media-body" style="text-align:left; height:75px">
							...
							<span style="clear: both; float: left; display: block; margin-top:10px;">Resposta do Fornecedor:</span>
...
<%-- 							<p style="width:50%; float:left;"><i class="glyphicon glyphicon-earphone"> ${item.usuario.telefone}</i> --%>
						...
						<c:if test="${item.situacao eq 'ENVIADO'}">
							<a class="btn btn-sm btn-warning pull-right" data-id="${item.idSolicitacao}" onclick="cancelarSolicitacaoForn(${item.idSolicitacao});" style="margin-top:5px;" href="#"><span class="glyphicon glyphicon-ban-circle"></span> Cancelar</a>
						</c:if>

						<c:if test="${item.situacao eq 'CONFIRMADO'}">
							<a class="btn btn-sm btn-primary pull-right" name="finalizar-servico" data-type-profile="forn" data-id="${item.idSolicitacao}" style="margin-top:5px;" href="#"><span class="glyphicon glyphicon-ok"></span>Finalizar</a>
						</c:if>
					</div>
		...
		<div class="modal-dialog">
        	<div class="modal-content">
            	...
            	<div class="modal-footer" style="clear:both">
                	...
                	<button type="button" class="btn orange" onclick="avaliarFinalizarSolicitacao('forn');">Confirmar</button>
            	</div>
            </div>
        </div>
	</div>
