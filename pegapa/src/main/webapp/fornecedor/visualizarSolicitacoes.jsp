...
<body>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<textarea style="resize:none" rows="3" cols="67" id="respSolicitacao" placeholder="Insira aqui alguma descrição ou texto que você ache relevante. O seu solicitante receberá esta mensagem por e-mail e na página dele."></textarea>
				</div>
				<div class="btn-group-justified">
					<a href='#' id="button" class='btn btn-primary' onclick="submeterSolicitacaoForn();" role='button'></a>
				</div>
			</div>
		</div>
	</div>
	...
	<script type="text/javascript" src="/pegapa/javascript/solicitacaoFornecedor.js" async="true" charset="utf-8"></script>
</body>
</html>